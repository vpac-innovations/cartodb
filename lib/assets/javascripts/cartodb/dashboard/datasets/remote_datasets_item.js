...
module.exports = DatasetsItem.extend({
  ...
  _canImportDataset: function() {
    ...
    console.log("this.user.get('remaining_byte_quota'):" + this.user.get('remaining_byte_quota'));
    console.log("UploadConfig.fileTimesBigger:" + UploadConfig.fileTimesBigger);
    console.log("this.user.get('limits'):" + this.user.get('limits'));
